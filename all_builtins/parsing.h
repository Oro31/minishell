...
/*   Updated: 2021/12/24 23:27:55 by rvalton          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_hdl_arg_unset(t_env **env, char **argv);
int		ft_unset(t_env **env, char *name);
void	ft_hdl_arg_export(t_env **env, char **argv);
int		ft_export(t_env **env, char *arg);
int		ft_pwd(void);
int		ft_exit(t_env **env, t_cmd **cmd, char **line, char *code);
void	ft_echo(char **argv);
void	ft_hdl_arg_cd(t_env **env, char **argv);
